...
def get_game_state():
    ...
    try:
        ...
        # Get player cards
        white_cards = [card.name for card in game_manager._white_player.cards if not card.used]
        black_cards = [card.name for card in game_manager._black_player.cards if not card.used]
